//Usage:  node createJob.js hardhatuser@protofire.io password123456789 0x01BE23585060835E02B77ef475b0Cc51aA1e0709
...
async function run() {
  const [email, password, oracleAddress] = process.argv.slice(2);
